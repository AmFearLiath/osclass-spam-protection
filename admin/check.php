    ...
    <div class="infobox halfrow">        
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td class="value"><?php echo '<a href="'.osc_admin_base_url(true).'?page=users&action=edit&id='.$item['fk_i_user_id'].'">'.$item['fk_i_user_id'].'</a>'; ?></td>
            </tr>
            <?php } ?>
            <?php if (isset($user['s_name'])) { ?>
            <tr>
                <td class="key"><?php _e('User Name', 'spamprotection'); ?></td>
                <td class="value"><?php echo '<a href="'.osc_admin_base_url(true).'?page=users&action=edit&id='.$item['fk_i_user_id'].'">'.$user['s_name'].'</a>'; ?></td>
            </tr>
            <?php } ?>
